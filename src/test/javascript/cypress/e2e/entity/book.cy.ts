...
describe('Book e2e test', () => {
  ...
  const bookSample = { tag: 'pfft excepting offend' };
  ...
  describe('new Book page', () => {
    ...
    it('should create an instance of Book', () => {
      cy.get(`[data-cy="name"]`).type('heavily');
      cy.get(`[data-cy="name"]`).should('have.value', 'heavily');

      cy.get(`[data-cy="price"]`).type('27566.99');
      cy.get(`[data-cy="price"]`).should('have.value', '27566.99');

      cy.get(`[data-cy="tag"]`).type('shot aha');
      cy.get(`[data-cy="tag"]`).should('have.value', 'shot aha');
