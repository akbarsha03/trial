...
class BookResourceIT {
    ...
    public static Book createEntity(EntityManager em) {
        Book book = new Book().name(DEFAULT_NAME).price(DEFAULT_PRICE).tag(DEFAULT_TAG);
        return book;
    }
    ...
    public static Book createUpdatedEntity(EntityManager em) {
        Book book = new Book().name(UPDATED_NAME).price(UPDATED_PRICE).tag(UPDATED_TAG);
        return book;
    }
    ...
    void putExistingBook() throws Exception {
        ...
        updatedBook.name(UPDATED_NAME).price(UPDATED_PRICE).tag(UPDATED_TAG);
    ...
    void partialUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.price(UPDATED_PRICE).tag(UPDATED_TAG);
    ...
    void fullUpdateBookWithPatch() throws Exception {
        ...
        partialUpdatedBook.name(UPDATED_NAME).price(UPDATED_PRICE).tag(UPDATED_TAG);
