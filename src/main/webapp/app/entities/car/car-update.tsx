  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="trialApp.car.home.createOrEditLabel" data-cy="CarCreateUpdateHeading">
            <Translate contentKey="trialApp.car.home.createOrEditLabel">Create or edit a Car</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label={translate('trialApp.car.name')} id="car-name" name="name" data-cy="name" type="text" />
