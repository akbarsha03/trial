...
export const CarDeleteDialog = () => {
  ...
  const handleClose = () => {
    navigate('/car' + pageLocation.search);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="trialApp.car.delete.question">
        <Translate contentKey="trialApp.car.delete.question" interpolate={{ id: carEntity.id }}>
